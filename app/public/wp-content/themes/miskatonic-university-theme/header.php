    ...
    <header class="site-header">
        <div class="container">
            ...
            -->
                    ...
                    <ul>
                        <li <?php if(
                is_page('about-us') or wp_get_post_parent_id(get_the_ID(0)==15)
              ){
...
?>><a href="<?php echo get_post_type_archive_link('event')?>">Events</a></li>
  ...
  <a href="<?php echo esc_url(site_url('/my-notes'))?>"  class="btn btn--small btn--orange float-left push-right">My notes</a>
                    ...
                    <a href="<?php echo wp_registration_url()?>" target="_blank" class="btn btn--small btn--dark-orange float-left push-right">Sign Up</a>
